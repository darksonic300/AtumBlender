...
import aeroblender.worldgen.DefaultAetherRegion;
...
public class Regions
{
    ...
    public static void register(ResourceLocation name, Region region)
    {
        ...
        AeroBlender.LOGGER.info("Registered region " + name + " to index " + index + " for type " + region.getType());
    }
    ...
    public static void remove(RegionType type, ResourceLocation name)
    {
        ...
        AeroBlender.LOGGER.info("Removed region " + name);
    }
    ...
    static
    {
        ...
        register(new DefaultAetherRegion(AeroBlender.CONFIG.vanillaAetherRegionWeight));
    }
}
