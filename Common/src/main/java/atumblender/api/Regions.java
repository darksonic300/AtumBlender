...
import atumblender.worldgen.DefaultAetherRegion;
...
public class Regions
{
    ...
    public static void register(ResourceLocation name, Region region)
    {
        ...
        AtumBlender.LOGGER.info("Registered region " + name + " to index " + index + " for type " + region.getType());
    }
    ...
    public static void remove(RegionType type, ResourceLocation name)
    {
        ...
        AtumBlender.LOGGER.info("Removed region " + name);
    }
    ...
    static
    {
        ...
        register(new DefaultAetherRegion(AtumBlender.CONFIG.vanillaAetherRegionWeight));
    }
}
