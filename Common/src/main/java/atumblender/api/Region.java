...
public abstract class Region
{
    ...
    public static final ResourceKey<Biome> DEFERRED_PLACEHOLDER = ResourceKey.create(Registries.BIOME, new ResourceLocation(AtumBlender.MOD_ID, "deferred_placeholder"));
