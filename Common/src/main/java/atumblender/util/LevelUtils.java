...
import atumblender.DimensionTypeTags;
import atumblender.api.RegionType;
import atumblender.api.Regions;
import atumblender.core.AtumBlender;
import atumblender.worldgen.IExtendedBiomeSource;
import atumblender.worldgen.IExtendedNoiseGeneratorSettings;
import atumblender.worldgen.IExtendedParameterList;
...
public class LevelUtils
{
    ...
    public static void initializeBiomes(RegistryAccess registryAccess, Holder<DimensionType> dimensionType, ResourceKey<LevelStem> levelResourceKey, ChunkGenerator chunkGenerator, long seed)
    {
        ...
        AtumBlender.LOGGER.info(String.format("Initialized TerraBlender biomes for level stem %s", levelResourceKey.location()));
    }
}
